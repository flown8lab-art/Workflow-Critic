...
CHANNELS = [
    ...
    'qa_jobs_ru',
    'data_jobs',
    'data_science_jobs_ru',
    'analyst_jobs_ru',
    'it_analytics_jobs',
    
    # Mobile/GameDev
    'mobile_developer_jobs',
    'mobile_jobs_ru',
    'game_dev_jobs',
    'gamedev_jobs_ru',
    ...
    'legal_remote_jobs',
    'finance_remote_jobs',
    'consulting_remote_jobs',
    'customer_support_jobs',
    'digital_nomads',
    'Crypto_Freelancers',
